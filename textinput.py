...
class MinhaApp(App):
    def build(self):
        ...
        layout_principal.add_widget(self.label1_mensagem)

        return layout_principal
    
    def exibir_mensagem(self, instance):
        nome_usuario = self.input_nome.text
        mensagem = f'Olá {nome_usuario}, você está avançado no Kivy! Parabéns SESIANO!!!'
        self.label1_mensagem.text = mensagem
